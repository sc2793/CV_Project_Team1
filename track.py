...
def run(
        ...
        json_name="bbox_annotation_ndjson.json",
        key_frame_spacing = 0,
):
...
def parse_opt():
    ...
    parser.add_argument('--json_name', default="bbox_annotation_ndjson.json", help='name for the json file with key frames')
